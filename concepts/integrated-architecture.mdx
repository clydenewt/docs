...
<CardGroup cols={2}>
  ...
  <Card title="Interchain Accounts (ICA)" icon="arrows-left-right">
...
Protocols can utilize Neutron's Interchain Accounts (ICA) and Interchain Queries (ICQ) modules to:
...
<CardGroup cols={2}>
  ...
  <Card title="ICA Module" icon="arrows-left-right" href="/developers/tutorials/cosmwasm_ica">
