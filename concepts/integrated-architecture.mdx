...
<CardGroup cols={2}>
  <Card title="DEX Module" icon="arrows-rotate" iconType="duotone" href="/developers/modules/dex">
  ...
  <Card title="Interchain Transactions (ICTX)" icon="arrows-left-right" iconType="duotone" href="/developers/modules/interchaintxs">
...
<CardGroup cols={2}>
  ...
  <Card title="Performance" icon="bolt" iconType="duotone">
    <ul className="mt-2 space-y-1">
      ...
      <li>High-frequency oracle updates every block (see [Oracle Overview](/operators/oracle/overview))</li>
    </ul>
  </Card>
...
### Supervaults
[Supervaults](/defi/supervaults) represent a new approach to liquidity provision that overcomes the limitations of traditional AMMs. By leveraging Neutron's [built-in high-frequency oracle](/operators/oracle/overview) and native automation features, Supervaults can:
