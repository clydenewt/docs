...
<div className="p-4 border-l-4 border-primary bg-primary/5 rounded my-6">
  Duality is a protocol-native DEX integrated directly into Neutron's core infrastructure. It enables professional-grade market making with Just-In-Time (JIT) orders, limit orders, and other advanced features to create a more efficient trading environment.
</div>
...
Duality is built directly into Neutron's core infrastructure, making it highly capital-efficient and integrated with other Neutron applications:
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 mb-8">
  ...
  <div className="flex flex-col">
    ...
    <p className="text-sm">As a core protocol module, Duality gains performance advantages and can serve as the base liquidity layer for other applications.</p>
  </div>
