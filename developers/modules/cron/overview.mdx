...
- **Reference**:
  ...
  - [Known Bugs](/developers/modules/cron/known-bugs) — known issues in the module.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 mb-8">
  ...
  <a className="flex flex-col p-5 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900" href="/developers/modules/cron/api">
    <h4 className="font-semibold mb-2">API Reference</h4>
    <p className="text-sm">API endpoints and message specifications</p>
  </a>
</div> 