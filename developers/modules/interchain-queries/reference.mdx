---
title: "ICQ Module Reference"
description: "Technical reference for the Interchain Queries module including API specifications, parameters, and data structures"
---
