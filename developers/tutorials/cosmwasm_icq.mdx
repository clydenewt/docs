...
# Interchain Queries with CosmWasm

This tutorial walks through building a smart contract that uses Neutron's Interchain Query (ICQ) module to query data from other blockchains.
