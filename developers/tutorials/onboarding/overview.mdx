...
<CardGroup cols={3}>
  <Card title="Part 1: Minimal Contract" icon="file-code" iconType="duotone" href="/old-docs/tutorials/onboarding/part-1-minimal-application">
    Learn to create and deploy a simple yet functional CosmWasm smart contract on Neutron
  </Card>
  <Card title="Part 2: Modules & Contracts" icon="cubes" iconType="duotone" href="/old-docs/tutorials/onboarding/part-2-calling-modules-and-contracts">
    Explore how to interact with Neutron modules and other contracts
  </Card>
  <Card title="Part 3: Web App" icon="globe" iconType="duotone" href="/old-docs/tutorials/onboarding/part-3-building-simple-web-app">
