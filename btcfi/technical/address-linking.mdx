...
description: "Understanding address coordination for BTCFi rewards and boosts"
icon: "link"
---

The BTCFi campaign uses an address linking system to coordinate rewards and boosts. This page explains how the system works with all deposits on Neutron.

<Info>
This page provides detailed context for users and integrators. For step-by-step instructions, see [How to Deposit](/btcfi/how-to-deposit).
</Info>
...
The address linking system is straightforward:
...
With all deposits on Neutron, the boost pointing system is straightforward:
...
**For Users**:
- Address linking is automatic for most users
...
<Note>
Most users simply deposit and boost from the same Neutron address without manual configuration.
</Note>
