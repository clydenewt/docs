---
title: "v9.0.0"
description: "Upgrade instructions for Neutron v9.0.0 mainnet upgrade"
icon: "arrow-up-right-dots"
---

- **Chain upgrade point**: November 19th 2025, 15:00 UTC (approximately), at height `40729000`
- **Go version**: `v1.23`
...
<Warning>
**COORDINATED MAINNET UPGRADE ON HEIGHT 40729000. DO NOT APPLY MANUALLY.**
</Warning>
...
The upgrade will take place approximately on **November 19th at 15:00 UTC** at height `40729000`.
...
### Current Runtime
The Neutron mainnet network, `neutron-1`, is currently running a previous version. We anticipate that operators will be able to upgrade successfully. Validators are expected to ensure that their systems are up-to-date and capable of performing the upgrade. This includes running the correct binary, or if building from source, building with go `1.23`.

### Target Runtime
The Neutron mainnet network, `neutron-1`, will run [Neutron v9.0.0](https://github.com/neutron-org/neutron/releases/tag/v9.0.0). Operators **MUST** use this version post-upgrade to remain connected to the network.
...
Check checksum of the binary if you decided to [download it](https://github.com/neutron-org/neutron/releases/tag/v9.0.0):
...
- **Use statically built binary**: Download from [official release](https://github.com/neutron-org/neutron/releases/tag/v9.0.0)
...
<Steps>
  <Step title="Run Current Version">
    Run your current Neutron version till upgrade height, the node will panic:
    ```shell
...
<Steps>
  <Step title="Create Cosmovisor Folder">
    Create a cosmovisor folder inside `$NEUTRON_HOME` and move your current Neutron binary:
    ```shell
  ...
  <Step title="Prepare v9.0.0 Binary">
    Build **Neutron v9.0.0**, and move neutrond v9.0.0:
    ```shell
...
Steps to skip this upgrade proposal are simply to resume the neutron-1 network with the previous binary using the following command:
...
- **Mainnet upgrade notes**: [GitHub - mainnet-assets/v9.0.0](https://github.com/neutron-org/mainnet-assets/tree/main/upgrades/v9.0.0)
