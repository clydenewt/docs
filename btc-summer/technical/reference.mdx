...
- **Supervault addresses** are contract addresses for liquidity provision
- **Oracle addresses** provide price feeds for campaign calculations
- **All addresses** are on Neutron mainnet unless otherwise specified
...
<CardGroup cols={2}>
  <Card title="Integration Guide" icon="plug" href="/btc-summer/technical/integrators">
    Complete integration requirements and processes
  </Card>
