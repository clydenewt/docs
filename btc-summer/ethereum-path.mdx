...
<Warning>
**Valence (Ethereum) vaults are sunsetting** - [Learn more](https://medium.com/neutronblog/sunsetting-bitcoin-summer-ethereum-vaults-8c60de1b9da0)

Valence is winding down, and all Bitcoin Summer **Ethereum** vaults will sunset on **November 1, 2025**. Deposits into Ethereum vaults are disabled; withdrawals are available through the sunset date. maxBTC minting on Ethereum via Structured remains available.
</Warning>
...
<Warning>
**Phase Timing**: Bitcoin Summer Phases last two months, and you can view the amount of time remaining in a Phase on the Bitcoin Summer dashboard. **Withdrawing your balance from a vault before the end of a 2-month Phase will cause you to forfeit proportional NTRN rewards corresponding to the amount withdrawn**.
</Warning>
