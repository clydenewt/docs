...
<Warning>
**Ethereum vaults were deprecated following Valence's decision to wind down** ([see announcement](https://medium.com/neutronblog/sunsetting-bitcoin-summer-ethereum-vaults-8c60de1b9da0)).

All deposits now go directly to Neutron positions. Any funds left in Ethereum vaults at the time of wind down will be refunded back to the Ethereum address used to make the deposits.
</Warning>
...
<Steps>
  <Step title="Navigate to Supervaults">
    Go to the [Bitcoin Summer dashboard](https://app.neutron.org/bitcoin-summer) and select the **Neutron Positions** tab, or go directly to [Supervaults](https://app.neutron.org/earn/supervaults).
  </Step>
