...
description: "Step-by-step guide for participating in BTCFi on Neutron"
icon: "wallet"
---
...
<Info>
This guide covers the evergreen deposit process. For current Phase-specific eligibility and reward multipliers, see [Phase 3 Details](/bitcoin-finance/neutron-path/phase-3).
</Info>
...
- Eligible BTC assets (check [Phase 3 Details](/bitcoin-finance/neutron-path/phase-3) for current eligible assets)
...
<Steps>
  <Step title="Navigate to Amber">
    Go to [app.amberfi.io](https://app.amberfi.io/deposit) or access Amber positions through the [BTCFi dashboard](https://app.neutron.org/bitcoin-finance).
  </Step>
...
<Steps>
  <Step title="Navigate to Supervaults">
    Go to the [BTCFi dashboard](https://app.neutron.org/bitcoin-finance) or directly to [Supervaults](https://app.neutron.org/earn/supervaults).
  </Step>
  <Step title="Choose a Supervault">
    Select a BTCFi eligible Supervault. Click on the vault to see details about:
    - APY and fees
...
<Steps>
  <Step title="Access Booster Feature">
    On the [BTCFi dashboard](https://app.neutron.org/bitcoin-finance), click the **"Unlock your booster"** button.
  </Step>
  ...
  <Step title="Stake & Lock NTRN">
    ...
    3. Choose amount and lock duration (up to 12 months for max boost)

    <Tip>
    **Maximize your boost**: Lock NTRN equal to your deposit value for 1 year to achieve 3x multiplier. During the lock period, you'll earn ~3% NTRN staking rewards + boosted BTCFi rewards.
    </Tip>
  </Step>
...
- **BTCFi dashboard**: [app.neutron.org/bitcoin-finance](https://app.neutron.org/bitcoin-finance) - Detailed performance metrics (hover over APY column to see reward breakdown)
...
Other rewards (principal, DeFi yields, partner points) are never forfeited and remain fully liquid. [Learn more about forfeitable rewards](/bitcoin-finance/campaign-details).
</Warning>
...
<Card title="Phase 3 Details" icon="calendar" href="/bitcoin-finance/neutron-path/phase-3">
...
<CardGroup cols={2}>
  ...
  <Card title="Campaign Details" icon="info" href="/bitcoin-finance/campaign-details">
...
<CardGroup cols={2}>
  ...
  <Card title="Technical Docs" icon="code" href="/bitcoin-finance/technical/overview">
