...
This guide will help you join Neutron's validator set after you have [set up your node](/operators/running-a-node) and [configured your oracle service](/operators/oracle/overview).
...
2. **Oracle Configuration**: Properly configured Connect oracle service (see [Oracle Setup](/operators/oracle/setup))
