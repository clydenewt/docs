...
<Note>
  This guide covers the basic node setup that serves both purposes. If you want to become a validator, refer to our [becoming a validator section](/operators/becoming-a-validator).
</Note>
  ...
  <Step title="Build or Download Neutron">
    <Tabs>
      <Tab title="Build from Source">
        ...
        cd neutron
        git checkout v8.1.1 # replace with the current version
        make install
        ```
      </Tab>
      <Tab title="Download Binary">
        ```bash
        wget https://github.com/neutron-org/neutron/releases/download/v8.1.1/neutrond-linux-amd64
...
<CardGroup cols={2}>
  ...
  <Card title="Validator Path" icon="server" iconType="duotone">
    ...
    1. Set up the [Connect Oracle Service](/operators/oracle/setup)
    2. Review [validator requirements](/operators/overview)
    3. Complete [validator registration](/operators/becoming-a-validator)
  </Card>
</CardGroup>
